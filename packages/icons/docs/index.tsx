import { Features, FeaturesProps } from '@arietta-studio/ui';
...
const items: FeaturesProps['items'] = [
  ...
  {
    description:
      'Arietta Icons boasts an active community of designers and developers. Engage with us on platforms like GitHub and Discord to contribute or get support.',
    icon: GitPullRequest,
